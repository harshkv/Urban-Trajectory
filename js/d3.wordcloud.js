  ...
  function wordcloud() {
    ...
    function draw(data, bounds) {
      ...
      text.enter().append("text")
        ...
        .duration(transitionDuration)
        .style("opacity", 1);
      text.style("Comic Sans MS", function(d) {
          return d.font || layout.font() || svg.style("Comic Sans MS");
        })
...
//Multiple web based searched and references such as stackoverflow, git  have been used in creating this project
